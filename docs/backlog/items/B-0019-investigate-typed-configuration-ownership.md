...
- pressure_dependencies: B-0003, B-0008, B-0012
...
- unresolved_semantics: common ownership boundary, typed values, source precedence, and construction lifecycle
