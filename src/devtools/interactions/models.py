...
class ConversationRef:
    """Represent opaque continuation state owned by an interaction source.
...
class InteractionTurn:
    """Represent the final result of one interaction invocation.

    :ivar message: Final message produced by the interaction.
    :ivar conversation: Optional continuation state returned by the interaction.
    """
