...
from devtools.interactions.models import ConversationRef, InteractionTurn
...
class LlamaCppInteraction:
    """Adapt one non-streaming llama.cpp chat interaction to Interaction."""

    def __init__(self, *, endpoint: str, model: str, source: MessageSource) -> None:
