...
from devtools.core.paths.errors import PathParsingError, PathResolutionError
from devtools.core.paths.models import ResolvedPath
...
def parse_dot_path(
    ...
    *,
    ...
    For example, ``"devtools.core.paths.models"`` becomes
