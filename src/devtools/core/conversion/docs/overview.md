# `devtools.core.conversion`

## Purpose

`devtools.core.conversion` is a small framework-neutral boundary around explicit,
...
```python
from devtools.core.conversion import (
    ConversionError,
    Converter,
    convert,
    convert_all,
...
`devtools.core.conversion` uses only Python standard-library callable and iterable
