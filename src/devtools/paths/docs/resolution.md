...
This document defines the operational contract for `devtools.paths`. See the
...
```python
parse_dot_path("devtools.paths.models")
# Path("devtools", "paths", "models")

parse_dot_path("devtools.paths.models", suffix=".py")
