...
if TYPE_CHECKING:
    ...
    from devtools.resources.commands.events import CommandEvent
    from devtools.resources.commands.models import CommandResult
...
class CommandExecution:
    ...
    :class:`~devtools.resources.commands.models.CommandResult`.
