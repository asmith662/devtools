...
from devtools.resources.filesystem.models.base import FileFormat
...
class MarkdownFile(TextFile):
    ...
    def sections(self) -> tuple[MarkdownSection, ...]:
        ...
        return tuple(
            self._build_section(index, headings) for index in range(len(headings))
        )
    ...
    def find_heading(
        ...
        *,
        ...
        for heading in self.headings:
            candidate = heading.text if case_sensitive else heading.text.casefold()
    ...
    def find_section(
        ...
        *,
        ...
        for section in self.sections:
            candidate = section.title if case_sensitive else section.title.casefold()
