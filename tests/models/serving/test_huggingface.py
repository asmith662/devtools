...
from devtools.models.serving.huggingface import (
    AcquiredGGUF,
    HuggingFaceGGUFRef,
    HuggingFaceModelRef,
    acquire_huggingface_gguf,
)
from devtools.models.serving.llama_cpp import GGUFModel
...
def test_acquire_gguf_maps_exact_identity_to_explicit_cache(
    ...
    monkeypatch.setattr("devtools.models.serving.huggingface.hf_hub_download", download)
...
def test_acquire_gguf_retains_snapshot_gguf_path_for_suffixless_blob(
    ...
    monkeypatch.setattr(
        "devtools.models.serving.huggingface.hf_hub_download",
